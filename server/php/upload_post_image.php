...
$hedefKlasor = __DIR__ . '/posts/'; // Dosyanın kaydedileceği klasörün yolu
...
try {
    ...
    echo str_replace("\\",'/',"http://".$_SERVER['HTTP_HOST'].substr(getcwd(),strlen($_SERVER['DOCUMENT_ROOT']))."/posts/") . $yol;
} catch (Exception $e) {
    echo false;
}
