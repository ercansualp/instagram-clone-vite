...
$hedefKlasor = __DIR__ . '/profile_pictures/'; // Dosyanın kaydedileceği klasörün yolu
...
try {
    ...
    echo str_replace("\\",'/',"http://".$_SERVER['HTTP_HOST'].substr(getcwd(),strlen($_SERVER['DOCUMENT_ROOT']))."/profile_pictures/") . $yol;
} catch (Exception $e) {
    echo false;
}
